...
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.jfltecan.$(shell date +%m%d%y).$(shell date +%H%M%S)

# overrides
PRODUCT_BUILD_PROP_OVERRIDES += \
    BUILD_NUMBER=573038 \
    PRODUCT_NAME=jfltecan \
    TARGET_BUILD_TYPE=user \
    BUILD_VERSION_TAGS=release-keys \
    PRIVATE_BUILD_DESC="jfltecan-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/jfltecan:4.2.2/JDQ39/573038:user/release-keys"
